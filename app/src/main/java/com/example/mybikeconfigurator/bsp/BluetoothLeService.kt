...
class BluetoothLeService : Service() {
    ...
    private val mGattCallback = object : BluetoothGattCallback() {
        ...
        override fun onConnectionStateChange(gatt: BluetoothGatt, status: Int, newState: Int) {
            Log.d(TAG, "BLECallbacks::onConnectionStateChanged")
        ...
        override fun onServicesDiscovered(gatt: BluetoothGatt, status: Int) {
            Log.d(TAG, "BLECallbacks::onServicesDiscovered")
        ...
        override fun onCharacteristicRead(
            ...
            Log.d(TAG, "BLECallbacks::onCharacteristicRead")
            if (status == BluetoothGatt.GATT_SUCCESS) {
        ...
        override fun onCharacteristicChanged(
            ...
            Log.d(TAG, "BLECallbacks::onCharacteristicChanged")
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic)
        }
    }
    ...
    private fun broadcastUpdate(
        ...
        Log.d(TAG, "broadcastUpdate with characteristic: $action")
        val intent = Intent(action)
        ...
        if (data != null && data.size > 0) {
            ...
            intent.putExtra(EXTRA_DATA, characteristic.uuid.toString() + "\n" + String(data) + "\n" + stringBuilder.toString())
    ...
    fun setCharacteristicNotification(
        ...
        Log.d(TAG, "readCharacteristicNotification()")
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapter not initialized")
            return
        }
    ...
    companion object {
        ...
        val EXTRA_BYTES = "com.example.bluetooth.le.EXTRA_BYTES"
    }
}
